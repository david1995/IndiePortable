// <copyright file="AsymmetricConnectionBase{TSend,TReceive,TAddress}.cs" company="David Eiwen">
...
namespace IndiePortable.Communication.Core.Devices.Connections
{
    ...
    public abstract class AsymmetricConnectionBase<TSend, TReceive, TAddress>
        : IDisposable
        where TSend : class
        where TReceive : class
    {
        ...
        protected AsymmetricConnectionBase()
        {
        ...
        /// <summary>
        /// Occurs when the <see cref="AsymmetricConnection{TMessage, TAddress}" /> has been disconnected.
        /// </summary>
        ...
        public event EventHandler<MessageReceivedEventArgs<TReceive>> MessageReceived;
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="AsymmetricConnectionBase{TSend,TReceive,TAddress}" /> is connected to the other end.
        /// </summary>
        /// <value>
        /// <c>true</c> if the <see cref="AsymmetricConnectionBase{TSend,TReceive,TAddress}" /> is connected; otherwise, <c>false</c>.
        /// </value>
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="AsymmetricConnectionBase{TSend,TReceive,TAddress}" /> is activated.
        /// </summary>
        /// <value>
        /// <c>true</c> if the <see cref="AsymmetricConnectionBase{TSend,TReceive,TAddress}" /> is activated; otherwise, <c>false</c>.
        /// </value>
        /// <remarks>
        /// <para>
        ...
        /// <summary>
        /// Activates the <see cref="AsymmetricConnectionBase{TSend,TReceive,TAddress}" />.
        /// </summary>
        /// <remarks>
        ...
        protected virtual void OnMessageReceived(TReceive message)
            => this.MessageReceived?.Invoke(this, new MessageReceivedEventArgs<TReceive>(message));
