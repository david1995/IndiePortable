...
namespace IndiePortable.Communication.Core.Devices.Connections.Decorators
{
    ...
    public class CryptoConnection<TAddress>
        : MessageConnectionBase<byte[], TAddress>
    {
        private readonly MessageConnectionBase<byte[], TAddress> decoratedConnection;

        private readonly Crypter crypter;

        public CryptoConnection(MessageConnectionBase<byte[], TAddress> decoratedConnection, Crypter crypter)
        {
