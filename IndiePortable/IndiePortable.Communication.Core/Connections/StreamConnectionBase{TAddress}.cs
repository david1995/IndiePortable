// <copyright file="StreamConnectionBase{TAddress}.cs" company="David Eiwen">
...
namespace IndiePortable.Communication.Core.Devices.Connections
{
    ...
    public abstract class StreamConnectionBase<TAddress>
        : IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StreamConnectionBase{TAddress}"/> class.
        /// </summary>
        /// <param name="dataStream">
        /// The stream source of the <see cref="StreamConnectionBase{TAddress}"/>.
        /// Must not be <c>null</c>.
        /// </param>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="dataStream"/> is <c>null</c>.
        /// </exception>
        ...
        /// <summary>
        /// Occurs when the <see cref="StreamConnectionBase{TAddress}" /> has been disconnected.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="StreamConnectionBase{TAddress}" /> is connected to the other end.
        /// </summary>
        /// <value>
        /// <c>true</c> if the <see cref="StreamConnectionBase{TAddress}" /> is connected; otherwise, <c>false</c>.
        /// </value>
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="StreamConnectionBase{TAddress}" /> is activated.
        /// </summary>
        /// <value>
        /// <c>true</c> if the <see cref="StreamConnectionBase{TAddress}" /> is activated; otherwise, <c>false</c>.
        /// </value>
        /// <remarks>
        /// <para>
        ...
        /// <summary>
        /// Activates the <see cref="StreamConnectionBase{TAddress}" />.
        /// </summary>
        /// <remarks>
        ...
        {
            await Task.Run(() => Monitor.Wait(this.writeLock));
            try
            {
                this.ConnectionState = ConnectionState.Disconnecting;
