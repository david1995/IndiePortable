// <copyright file="ConnectionBase{TMessage, TAddress}.cs" company="David Eiwen">
...
namespace IndiePortable.Communication.Core.Devices
{
    ...
    public abstract class ConnectionBase<TMessage, TAddress>
        : IDisposable
        where TMessage : class
    {
        ...
        /// <summary>
        /// Occurs when the <see cref="ConnectionBase{TMessage, TAddress}" /> has been disconnected.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="ConnectionBase{TMessage, TAddress}" /> is connected to the other end.
        /// </summary>
        /// <value>
        /// <c>true</c> if the <see cref="ConnectionBase{TMessage, TAddress}" /> is connected; otherwise, <c>false</c>.
        /// </value>
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="ConnectionBase{TMessage, TAddress}" /> is activated.
        /// </summary>
        /// <value>
        /// <c>true</c> if the <see cref="ConnectionBase{TMessage, TAddress}" /> is activated; otherwise, <c>false</c>.
        /// </value>
        /// <remarks>
        /// <para>
        ...
        /// <summary>
        /// Activates the <see cref="ConnectionBase{TMessage, TAddress}" />.
        /// </summary>
        /// <remarks>
