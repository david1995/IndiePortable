...
namespace IndiePortable.Communication.Core.Devices
{
        ...
        : IDisposable
    {
        ...
        private readonly IDictionary<Type, IConnectionMessageHandler> messageHandlers =
            new Dictionary<Type, IConnectionMessageHandler>();

        /// <summary>
        /// The list containing all currently waiting message response tasks.
        /// </summary>
        private readonly IList<IWaitingTask> waitingTasks = new List<IWaitingTask>();
            ...
            where T : ConnectionMessageBase
        {
            ...
            this.messageHandlers.Add(typeof(T), messageHandler);
        }
        ...
        public void RemoveMessageHandler<T>()
            where T : ConnectionMessageBase
            => this.RemoveMessageHandler(typeof(T));
        ...
        {
            if (!this.messageHandlers.Remove(t ?? throw new ArgumentNullException(nameof(t))))
            {
        ...
        /// <exception cref="TimeoutException">
        /// <para>
        /// Thrown if the <see cref="ConnectionMessageDispatcher{TAddress}" /> has been waiting longer than <paramref name="timeout" /> for the response.
        /// </para>
        /// </exception>
            ...
            where TResponse : ConnectionMessageResponseBase<TRequest>
        {
            ...
            {
                this.requestMessageBacking = request ?? throw new ArgumentNullException(nameof(request));
            ...
            /// <summary>
            /// Gets a value indicating whether the <see cref="WaitingTask{TRequest, TResponse}" />is disposed.
            /// </summary>
            /// <value>
            ...
            public bool PushMessage(ConnectionMessageBase response)
            {
                switch (response)
                {
                    case null: throw new ArgumentNullException(nameof(response));
                    ...
                    default: throw new ArgumentException("The message is not of the required type.", nameof(response));
                }
            }
