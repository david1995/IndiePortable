...
namespace IndiePortable.Communication.Core.Devices.Connections.Decorators
{
    ...
    public abstract class ConnectionDecorator<TMessage, TAddress>
        : ConnectionBase<TMessage, TAddress>
        where TMessage : class
    {
        protected ConnectionDecorator(ConnectionBase<TMessage, TAddress> decoratedConnectoin)
        {
        ...
        protected ConnectionBase<TMessage, TAddress> DecoratedConnection { get; }
