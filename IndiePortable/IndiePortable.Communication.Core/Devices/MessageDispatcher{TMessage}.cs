...
namespace IndiePortable.Communication.Core.Devices
{
        ...
        where TMessage : class
    {
        ...
        ///     Thrown if <paramref name="messageHandler" /> is not registered at the <see cref="MessageDispatcher{TMessage}" />.
        /// </exception>
        ...
        /// </list>
        /// </exception>
        public TMessage WaitResponse(TMessage request, Predicate<TMessage> determinator)
        {
